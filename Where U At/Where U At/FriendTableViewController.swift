...
class FriendTableViewController: UITableViewController {
    ...
    @IBAction func addAFriend(sender: UIBarButtonItem) {
    ...
    func loadSampleFriends(){
        let friend1 = Friend(username: "Holly")
        let friend2 = Friend(username: "The Flash")
        let friend3 = Friend(username: "Moscar")
